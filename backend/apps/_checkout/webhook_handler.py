...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        ...
        subject = render_to_string(
            '_checkout/confirmation_emails/confirmation_email_subject.txt',
            {'order': order})
        body = render_to_string(
            '_checkout/confirmation_emails/confirmation_email_body.txt',
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if username != 'AnonymousUser':
            ...
            if save_info:
                profile.default_first_name = shipping_details.name.split()[0]
                profile.default_last_name = shipping_details.name.split()[1]
        ...
        if order_exists:
            ...
            try:
                order = Order.objects.create(
                    ...
                    original_cart=shipping_details.original_cart,
                    stripe_pid=pid,
                )
