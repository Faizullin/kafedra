...
const Checkout: FC<ICheckoutProps> = () => {
    ...
    return (
        <Box py="50px" px={["20px", "20px", "10%"]}>
            <CHeading mainText={"CHECKOUT"} subText={"Order your products by filling the neccessary information."}/>
                            ...
                            <Box bgColor="white" p="20px">
                                <Box>
                                    <h2>
                                        ...
                                        <FormControl my="5">
                                            <FormLabel fontSize="12px" color="gray.400" top="7px"
                                                       left="17px">Fullname:</FormLabel>
                                            <Input type="text" name="fullname" my="1" fontSize="14px" borderRadius="0"/>
                                        </FormControl>
                                        <FormControl my="5">
                                            <FormLabel fontSize="12px" color="gray.400" top="7px" left="17px">Email
                                                address:</FormLabel>
                                            <Input type="text" name="email" my="1" fontSize="14px" borderRadius="0"/>
                                        </FormControl>
                                        <FormControl my="5">
                                            <FormLabel fontSize="12px" color="gray.400" top="7px" left="17px">Company
                                                (optional):</FormLabel>
                                ...
                                <Box my="4">
                                    <h2>
                                        ...
                                        <FormControl my="5">
                                            <FormLabel fontSize="12px" color="gray.400" top="7px" left="17px">Shipping
                                                address:</FormLabel>
                                            <Input type="text" name="address" my="1" fontSize="14px" borderRadius="0"/>
                                        </FormControl>
                                        <FormControl my="5">
                                            <FormLabel fontSize="12px" color="gray.400" top="7px"
                                                       left="17px">Address:</FormLabel>
                                            <Input type="text" name="state" my="1" fontSize="14px" borderRadius="0"/>
                                        </FormControl>
                                        {/*<FormControl my="5">*/}
                                        {/*    <FormLabel fontSize="12px" color="gray.400" top="0px"*/}
                                        {/*               left="17px">Country:</FormLabel>*/}
                                        {/*    <Select*/}
                                        ...
                                        {/*</FormControl>*/}
                                        {/*<FormControl my="5">*/}
                                        {/*    <FormLabel fontSize="12px" color="gray.400" top="5px"*/}
                                        {/*               left="17px">State:</FormLabel>*/}
                                        {/*    <Select onChange={(e) => setStateCode(e.target.value)} my="1"*/}
                                        {/*            fontSize="14px" borderRadius="0">*/}
                                        {/*        {*/}
                                        ...
                                        {/*</FormControl>*/}
                                        <FormControl my="5">
                                            <FormLabel fontSize="12px" color="gray.400" top="7px" left="17px">Phone
                                                number:</FormLabel>
                ...
                <Box w={["100%", "100%", "36%"]} border="1px solid #f4f4f4" fontSize="14px" p="20px" mx={[0, 0, "2%"]}>
                    <Box>
                        ...
                        <Flex my="5" justify="space-between">
                            <FormControl w="70%">
                                <FormLabel fontSize="12px" color="gray.400" top="7px" left="17px">Expiry
                                    date:</FormLabel>
                    ...
                    <Flex m="20px 0" bgColor="white" p="10px 0">
                        <CLink to="/order" p="12px" w="100%" textAlign="center" borderRadius="2px" color="white"
                               bgColor="brand.900">Place order</CLink>
                    </Flex>
